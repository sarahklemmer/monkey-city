...
public class BuildingSelector : MonoBehaviour
{
    ...
    public void Select(BuildingBase b)
    {
        ...
        if (TutorialManager.instance.isActive && TutorialManager.instance.currentStepIndex == 4)
        {
            Debug.Log($"Tutorial active, completing step {TutorialManager.instance.currentStepIndex}");
            TutorialManager.instance.OnStepCompleted();
        }
        Debug.Log($"isActive: {TutorialManager.instance.isActive}, currentStepIndex: {TutorialManager.instance.currentStepIndex}");
    }
